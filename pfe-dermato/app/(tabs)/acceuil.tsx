...
const recentAnalyses: Analysis[] = [
  {
    ...
    color: '#10b981',
    bgColor: '#d1fae5',
    img: 'https://images.unsplash.com/photo-1585747860715-2ba37e788b70?w=120&h=120&fit=crop',
    tag: 'Faible risque',
  },
  {
    id: 2,
    ...
    color: '#f59e0b',
    bgColor: '#fef3c7',
    img: 'https://images.unsplash.com/photo-1559181567-c3190ca9be46?w=120&h=120&fit=crop',
    tag: 'Suivi conseillé',
  },
];
...
export default function HomeScreen() {
  // ✅ CORRIGÉ : hooks appelés à l'intérieur du composant (pas au niveau module)
  ...
  const [formData, setFormData] = useState({
    nom: '', age: '', antecedents: '', allergies: '',
  });

  // ✅ CORRIGÉ : fonctions définies à l'intérieur du composant (utilisent router/pathname)
      ...
      <ScrollView style={s.scroll} contentContainerStyle={s.scrollContent}
        ...
        <View style={s.header}>
          <View>
            ...
            <Text style={s.userName}>Jean Dupont</Text>
          </View>
        ...
        <View style={s.cardsRow}>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              if (!formSubmitted) { setShowFormModal(true); setFormError(false); return; }
              router.push('/scan'); // à remplacer par gallery mode
            }}>
        ...
        <View style={s.sectionHeader}>
          ...
          <TouchableOpacity style={s.seeAllBtn} onPress={() => router.push('/historique')}>
        ...
        <View style={s.conseilCard}>
          <View style={s.conseilLeft}>
            <Text style={{ fontSize: 28 }}>☀️</Text>
          </View>
          <View style={{ flex: 1 }}>
            <Text style={s.conseilTitle}>Protection solaire</Text>
            <Text style={s.conseilText}>
              Appliquez un SPF 30+ chaque jour, même par temps nuageux. Votre peau vous remerciera.
            </Text>
            <TouchableOpacity style={s.conseilBtn}>
      ...
      <View style={s.navbar}>
        {(
          [
            ...
            { id: 'conseil',   label: 'Conseil',   Icon: IconBulb  },
